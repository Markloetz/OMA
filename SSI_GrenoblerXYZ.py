...
if __name__ == '__main__':
    ...
    with open('Data/SSI_Data/freqsGrenoblerXYZ.pkl', 'wb') as f:
        pickle.dump(freqs, f)
    with open('Data/SSI_Data/modesGrenoblerXYZ.pkl', 'wb') as f:
        pickle.dump(modes, f)
    with open('Data/SSI_Data/zetaGrenoblerXYZ.pkl', 'wb') as f:
        pickle.dump(zeta, f)
    with open('Data/SSI_Data/statusGrenoblerXYZ.pkl', 'wb') as f:
