...
if __name__ == '__main__':
    ...
    mac_lim = 0.08  # Mode stability (MAC-Value)
    ...
    with open('Data/SSI_Data/freqsTiflis2.pkl', 'rb') as f:
        freqs = pickle.load(f)
    with open('Data/SSI_Data/statusTiflis2.pkl', 'rb') as f:
    ...
    for i in range(nPeaks):
        ...
        oma.animate_modeshape(N,
                              ...
                              zeta_n=zeta_ssi[i],
                              mpc=MPC_ssi[i],
                              directory="Animations/Tiflis2_SSI/",
                              mode_nr=i,
                              plot=True)
